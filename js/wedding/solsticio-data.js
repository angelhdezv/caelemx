...
export const solsticioData = {
 ...
 media: {...weddingData.media, gallery:weddingData.media.gallery.slice(0,2)},
 ...
 presentation: {solsticio:{galleryTitle:"Los días contigo",galleryNote:"En los pequeños momentos también vive lo eterno.",venueTitle:"La bendición de nuestra unión",mapsLabel:"Ver ubicación"}}
};
